...
private:
    ...
    geometry_msgs::TwistStamped _last_published_twist;
    ...
    void detectMarkers(cv::Mat& image, cv::Point2f& center1, cv::Point2f& center2, cv::Point2f& center3, const std::string& windowName);
